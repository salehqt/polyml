...
#define POLY_version_number    541
...
// We currently export version 5.4.1 but will support 5.4, 5.3, 5.2 or 5.1.
#define FIRST_supported_version 510
#define LAST_supported_version  541

#define TextVersion             "5.4.1"
